...
const sendEmail = async (mailOptions) => {
  ...
  if (config.isProduction) {
    console.error('[Mail] Fatal Error: RESEND_API_KEY is required in production.');
    process.exit(1);
  }

  // Fallback Mock Sender for local development
  console.log('[Mail] Missing RESEND_API_KEY. Using log-only mock mail sender.');
